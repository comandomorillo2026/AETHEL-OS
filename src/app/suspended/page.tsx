...
export default function SuspendedPage() {
  ...
  const [fileSize, setFileSize] = useState(25); // Deterministic default, updated on client
  ...
  // Set random file size only on client
  useEffect(() => {
    setFileSize(Math.floor(Math.random() * 50 + 10));
  }, []);
