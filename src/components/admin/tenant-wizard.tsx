...
const INDUSTRIES = [
  { slug: 'clinic', name: 'Clínica', icon: '🏥', color: '#22D3EE' },
  { slug: 'nurse', name: 'Enfermería', icon: '💉', color: '#34D399' },
  { slug: 'lawfirm', name: 'Bufete de Abogados', icon: '⚖️', color: '#C4A35A' },
  { slug: 'beauty', name: 'Salón de Belleza', icon: '💇', color: '#EC4899' },
  { slug: 'bakery', name: 'Panadería', icon: '🥐', color: '#F59E0B' },
  { slug: 'pharmacy', name: 'Farmacia', icon: '💊', color: '#8B5CF6' },
  { slug: 'insurance', name: 'Seguros', icon: '🛡️', color: '#6366F1' },
];
